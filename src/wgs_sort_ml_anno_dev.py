...
def print_barcodes(cbfile, n, outdir, sample, genomefa, allcpath):
    ...
    # Define a thread task to output elements in sublists
    def task(sublist, outdir, sample, genomefa):
        ...
        for barcode in sublist:
            ...
            run(cmd, shell=True)
    # Create a thread for each sublist and start it
    threads = []
    ...
    print('All cell coverage statistics have been completed!')
    # return df
